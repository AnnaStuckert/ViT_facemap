...
from torch.nn import CrossEntropyLoss, MSELoss, Dropout, Softmax, Linear, Conv2d, LayerNorm
...
class VisionTransformer(nn.Module):
    def __init__(self, config, img_size=224, num_classes=24, zero_head=False, vis=False):
    ...
    def forward(self, x, labels=None):
        ...
        if labels is not None:
            loss_fct = MSELoss()
            labels = labels.view(labels.shape[0], 24)
